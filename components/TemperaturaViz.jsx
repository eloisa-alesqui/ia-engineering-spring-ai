...
const CONTEXTS = [
  ...
  },
  {
    ...
    tokens: [
      { label: 'resume',    logit: 3.2 },
      { label: 'analiza',   logit: 2.7 },
      { label: 'presenta',  logit: 2.3 },
      { label: 'describe',  logit: 1.5 },
      { label: 'muestra',   logit: 1.0 },
      { label: 'detalla',   logit: 0.4 },
      { label: 'explica',   logit: -0.1 },
      { label: 'concluye',  logit: -0.8 },
    ],
  },
  {
